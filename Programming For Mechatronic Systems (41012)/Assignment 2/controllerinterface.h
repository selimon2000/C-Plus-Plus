...
public:
  ...
  */
  virtual void run(void) = 0;  //DONE, implemented in both quadcopter and ackermann files

  /**
  Retrurns platform status (indicating if it is executing a series of goals or idle - waiting for goals)
  @return platform status
  */
  virtual pfms::PlatformStatus status(void) = 0;  //implemented in quadcopter file
