...
TEST(AckermanReachGoals, TwoGoals)
{
    ...
    goals.push_back(pfms::geometry_msgs::Point{4, -2});
    goals.push_back(pfms::geometry_msgs::Point{10, 6});
    goals.push_back(pfms::geometry_msgs::Point{21, -2});
    goals.push_back(pfms::geometry_msgs::Point{-3, -13});
    goals.push_back(pfms::geometry_msgs::Point{-14, -21});
    ...
    double distance = pow(pow(odo.position.x - goals.at(4).x, 2) + pow(odo.position.y - goals.at(4).y, 2), 0.5);
