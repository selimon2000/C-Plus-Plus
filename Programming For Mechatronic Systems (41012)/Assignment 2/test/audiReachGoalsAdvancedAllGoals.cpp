...
TEST(AckermanReachGoals, TwoGoals)
{
    ...
    goals.push_back(pfms::geometry_msgs::Point{-11, -20});
    goals.push_back(pfms::geometry_msgs::Point{-10, 40});
    goals.push_back(pfms::geometry_msgs::Point{-18, 40});
    ...
    double distance = pow(pow(odo.position.x - goals.at(8).x, 2) + pow(odo.position.y - goals.at(8).y, 2), 0.5);
