...
class Person {
public:
    //    1) TASK1: The `Person` class is missing a special member function. This function needs to enable crteating an object of
...
Person(std::string inputName, unsigned int inputAge, bool inputVaccinated);
